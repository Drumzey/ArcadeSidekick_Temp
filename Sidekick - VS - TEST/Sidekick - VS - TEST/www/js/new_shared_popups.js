...
var successOnlinePopupWithMessages =
    '<div data-role="content" class="ui-corner-bottom ui-content" role="main"> \
        <h3>Welcome back!</h3> \
        <h6>You have unread messages in your inbox</h6> \
        <a onclick="PostRestoreUser();GoToNotifications();" data-role="button" data-corners="true" data-shadow="true" data-iconshadow="true" data-wrapperels="span" class="ui-btn ui-shadow ui-btn-corner-all ui-btn-up-c"><span class="ui-btn-inner ui-btn-corner-all"><span class="ui-btn-text">Messages</span></span></a> \
        <a onclick="PostRestoreUser()" data-role="button" data-corners="true" data-shadow="true" data-iconshadow="true" data-wrapperels="span" class="ui-btn ui-shadow ui-btn-corner-all ui-btn-up-c"><span class="ui-btn-inner ui-btn-corner-all"><span class="ui-btn-text">Exit</span></span></a> \
     </div>';
